...
import { vars, cssInterop, useColorScheme } from 'nativewind';
...
var SCOPE = "BUTTON";
var Root = withStyleContext(Pressable, SCOPE);
...
var ButtonText = React2.forwardRef(({ className, variant, size, action, ...props }, ref) => {
  const {
...
var ButtonIcon = React2.forwardRef(({ className, size, ...props }, ref) => {
  const {
    variant: parentVariant,
    size: parentSize,
    action: parentAction
